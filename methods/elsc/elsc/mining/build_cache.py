...
from slr_common.data.word_offsets import (
    eligible_word_units,
    encode_with_offsets,
...
from elsc.upstream.factory import (
    build_retriever_from_checkpoint,
...
from slr_common.utils import atomic_json_dump, git_worktree_state, sha256_file, sha256_json
