...
configure_control methods/elsc/configs/ph_min.yaml "$min_cache" "$matched_min_config"
...
for name in shuffled_lexical head_only local_word_video; do
  case "$name" in
    shuffled_lexical) template=methods/elsc/configs/ablation_shuffled_lexical.yaml ;;
    head_only) template=methods/elsc/configs/ablation_head_only.yaml ;;
    local_word_video) template=methods/elsc/configs/ablation_local_word_video.yaml ;;
  esac
...
configure_control methods/elsc/configs/ablation_random_neighbors.yaml "$random_cache" "$random_config"
check_disk
