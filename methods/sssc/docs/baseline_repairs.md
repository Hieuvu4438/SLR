...
| Custom gather backward returns only the local slice | Sum full output gradient across ranks, then return local slice | IMPLEMENTED; two-rank parity still unexecuted |
