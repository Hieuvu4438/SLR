...
def evaluate_warmup_gallery(
    ...
    *,
    ...
    if len(gallery.video_ids) != gallery.batch.pose.shape[0]:
...
def _dev_gallery_fingerprint(gallery: WarmupGallery) -> str:
    relevance = {
...
def run_evidence_warmup(
    ...
    *,
    ...
    for epoch in range(1, epochs + 1):
        ...
        metrics = evaluate_warmup_gallery(
            model,
            dev_gallery,
            tau_alignment=float(evidence["tau_alignment"]),
        ...
        save_training_checkpoint(
            ...
            sampler_state={"stage": "warmup", "epoch_step": observed_steps},
    ...
    checkpoint_checksum = winner_checkpoint.with_suffix(
        winner_checkpoint.suffix + ".sha256"
