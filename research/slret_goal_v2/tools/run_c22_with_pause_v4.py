"""Run registered C22 while temporarily pausing the exact UniFormerV2 worker."""
import sys
from pathlib import Path

import run_c21_with_pause_v4 as wrapper

wrapper.JOB='v4-c22-phase-modulation-001'
wrapper.OUT=wrapper.ROOT/'artifacts/slret_goal/jobs'/wrapper.JOB
wrapper.REPORT=wrapper.OUT/'pause_contract.json'
wrapper.CANDIDATE_ENTRY=wrapper.ROOT/'research/slret_goal_v2/tools/run_c22_phase_modulation_v4.py'
